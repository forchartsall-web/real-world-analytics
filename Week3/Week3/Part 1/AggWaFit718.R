...
#    Note that this calculates the OWA assuming the data are arranged from lowest to highest - 
#   this is opposite to a number of publications but was used in the text for consistency with 
#   other functions requiring a reordering of the inputs.
